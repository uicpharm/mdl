...
function curl_api {
   local -r mname="$1"
   local -r args="$2"
   local -r access_token_file="$MDL_ENVS_DIR/$mname/access_token.txt"
   local access_token
...
for mname in $mnames; do
   ...
   access_token_file="$MDL_ENVS_DIR/$mname/access_token.txt"
   refresh_token_file="$MDL_ENVS_DIR/$mname/refresh_token.txt"
