      ...
      nav: [
         ...
         { text: 'Migration', link: 'migration' },
         {
            ...
            items: [
               ...
               { text: 'Scheduled Tasks', link: 'schedtasks' },
         ...
         },
         {
            ...
            items: [
               ...
               { text: 'Development Help', link: 'development' },
               { text: 'Proxy Help', link: 'proxy' },
               { text: 'Troubleshooting Help', link: 'troubleshooting' },
            ],
         },
      ],
      socialLinks: [
         { icon: 'github', link: 'https://github.com/uicpharm/moodle' },
      ],
   },
});
